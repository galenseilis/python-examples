...
def simulate_monty_hall(num_simulations, csv_filename="monty_hall_simulation.csv"):
    ...
    for _ in range(num_simulations):
        ...
        available_doors = [door for door in range(3) if door != player_choice and door != car_position]
        ...
        if switch:
            ...
            player_choice = next(door for door in range(3) if door != player_choice and door != monty_opens)
