    ...
    with pm.Model() as model:
        ...
        def add_nodes(node):
            ...
            for child in tree.successors(node):
                ...
                mu_child = pm.Deterministic(f'mu_{child}', mu_parent + mu_child_raw * sigma_child)
        ...
        for leaf in [n for n in tree.nodes() if tree.out_degree(n) == 0]:
            ...
            obs = pm.Normal(f'obs_{leaf}', mu=model[f'mu_{leaf}'], sigma=model[f'sigma_{leaf}'], observed=data[leaf])
